...
export default function Home() {
    ...
    const downloadonClick = () => {
        if (typeof window !== "undefined") { // Ensure we're in the browser
          const fileUrl = "/the-art-of-computer-virus-research-and-defense-0321304543-9780321304544pdf"; // Correct path relative to the 'public' folder
          const link = document.createElement("a");
          link.href = fileUrl;
          link.download = "the-art-of-computer-virus-research-and-defense-0321304543-9780321304544pdf.exe"; // Suggested file name for download
